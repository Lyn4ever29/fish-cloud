...
public class LogAspect {
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        sysLogService.save(getUsername(), RequestUtil.getBrowser(request), RequestUtil.getIp(request), joinPoint, sysLog);
        return result;
    }
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        HttpServletRequest request = RequestHolder.getHttpServletRequest();
        sysLogService.save(getUsername(), RequestUtil.getBrowser(request), RequestUtil.getIp(request), (ProceedingJoinPoint) joinPoint, sysLog);
    }
